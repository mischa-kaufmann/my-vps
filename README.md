...
1. **Clone this repository to your control machine:**
    ...
    ``` Bash
    git clone https://github.com/mischa-kaufmann/my-vps.git # Replace with your fork if necessary
    cd my-vps
    ```
...
1. **Clone this repository onto your VPS:**
    ...
    ``` Bash
    git clone https://github.com/mischa-kaufmann/my-vps.git # Or your fork
    cd my-vps
    ```
